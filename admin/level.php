...
if(isset($_POST["addFaculty"])){
    ...
    $insert = "INSERT INTO level (`name`,`date`) VALUES ('$faculty','$date')";
...
<body class=" h-[100vh]" style="font-family: poppins;">
    ...
    <div class=" ml-60 pt-6 pr-4">
        <div class="grid grid-cols-2">
            <div>
                <p class="text-[25px]">Manage Level</p>
            </div>

            <div class="pb-10">
                <form class="flex " action="" method="post">
                    <input type="search" name="faculty" id="myInput" placeholder="Add a Faculty"
