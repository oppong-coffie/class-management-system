...
if(isset($_POST["addYear"])){
    ...
    $insert = "INSERT INTO accademicYear (`name`,`date`) VALUES ('$faculty','$date')";
    $query = $db->query($insert);
    if($query){
        echo"
            <script>;
                alert('Accademic Year added successfully');
            </script>;
        ";
    }
}
...
<body class=" h-[100vh]" style="font-family: poppins;">
    ...
    <div class=" ml-60 pt-6 pr-4">
        <div class="grid grid-cols-2">
            <div>
                <p class="text-[25px]">Manage Accademic Year</p>
            </div>

            <div class="pb-10">
                <form class="flex " action="" method="post">
                    <input type="search" name="year" id="myInput" placeholder="Add accademic yeaar"
                        class="bg-blue-50 border border-blue-200 focus:border-blue-600 h-10 shadow-sm w-[400px] rounded-md pl-4 outline-none">

                    <input name="addYear" value="Add"
                                        ...
                                        echo '
                                            <div class="flex gap-2 ">
                                                <a onclick="return confirm("Are you sure you want to delete?")" href="teacher_reg.php?id='.$row['Id'].'">
                                                    <div class=" text-white bg-blue-600  w-20 text-center rounded-sm">
                                                        <button>
                                                            Active
                                                        </button>
                                                    </div>
