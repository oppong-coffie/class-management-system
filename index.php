...
<body class="" style="font-family: poppins;">
    ...
    <div class="lg:grid lg:grid-cols-2">
        <!-- login image -->
        <div>
            <img class="lg:w-[50vw] lg:h-[100vh] mix-blend-normal" src="images/african-american-family-is-sitting-table-home-filling-out-paperwork-financial-documents_503750-230.avif" alt="">
        </div>
