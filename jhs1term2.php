...
//START:: MATHS DATA
 ...
 $mathsexercisesql = "SELECT * FROM scores WHERE std_id='$std_id' AND `subject`='maths' AND type='exercise' AND term =2 AND class='jhs1'";
 ...
 $mathshomeworksql = "SELECT * FROM scores WHERE std_id='$std_id' AND subject='maths' AND type='homework' AND term =2 AND class='jhs1'";
...
$mathsexamsql = "SELECT * FROM scores WHERE std_id='$std_id' AND subject='maths' AND type='exam' AND term =2 AND class='jhs1'";
...
//START:: ENGLISH DATA
 ...
 $englishexercisesql = "SELECT * FROM scores WHERE std_id='$std_id' AND subject='english' AND type='exercise' AND term =2 AND class='jhs1'";
 ...
 $englishhomeworksql = "SELECT * FROM scores WHERE std_id='$std_id' AND subject='english' AND type='homework' AND term =2 AND class='jhs1'";
...
$englishexamsql = "SELECT * FROM scores WHERE std_id='$std_id' AND subject='english' AND type='exam' AND term =2 AND class='jhs1'";
...
<head>
    ...
    <title>STUDENTS RESULTS || jhs1term2</title>
    <!-- assets -->
    <!-- assets -->
                ...
                <div>
                    ...
                    <div class="flex justify-center mt-10">
                        <div class="text-center">
                            ...
                            <p>Mends Gyan</p>
                            <p class="text-[14px] text-gray-500">SHS One(1)</p>
                        </div>
                    </div>
                </div>
