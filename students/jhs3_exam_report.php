    ...
    <div class="">
        ...
        <div class=" ml-64 pt-6 grid grid-cols-3">
            ...
            <table id="myTable" class="table w-[800px]" id="container">
                        ...
                        $roportdetails = mysqli_query($connection, "SELECT scores.*, students.name FROM scores JOIN students ON scores.std_id = students.std_id WHERE scores.subject = '$subject' AND scores.teacher_id = '$teacherid'");
